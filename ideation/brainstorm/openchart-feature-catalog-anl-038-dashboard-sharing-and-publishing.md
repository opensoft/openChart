# Dashboard Sharing And Publishing — Brainstorm

Status: brainstorm
Kind: architecture
Summary: Controls who can view, edit, certify, embed, or revoke a dashboard across personal and organizational audiences.
Topics: openchart-feature-catalog, analytics, frappe, dashboard-sharing
Repository context: openChart — Frappe v15 native EMR; catalog entry ANL-038 (Analytics Reporting Dashboards)
Captured: 2026-08-24

## Possible feats

- **Time-Bounded Public Displays Can Rotate** — time-bounded public displays can rotate revocable, minimum-necessary dashboard views.

## Focus

This feature isolates one capability: controls who can view, edit, certify, embed, or revoke a dashboard across personal and organizational audiences. It keeps analytical interpretation explicit so openChart users and pluggable open-source BI tools can share semantics without a proprietary reporting lock-in.

## Behavior

- Dashboard Owners and Publishers start from a dashboard version, audience, permissions, expiry, and publication rationale.
...
- A successful run produces a governed share or publication with immutable audience and content evidence.
...
- Access conflicts, stale certification, or embedded-scope mismatch prevent sharing.
...
- **DocTypes:** `OC Dashboard Publication` uses `OC-ANL-.YYYY.-.#####` naming with owner, status, definition version, JSON parameters, source watermark, permission scope, and lineage Links; child tables hold dimensions, filters, recipients, or result references as appropriate.
